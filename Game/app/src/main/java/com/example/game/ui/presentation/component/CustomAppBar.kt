package com.example.navigationbrunelajpc.ui.presentation.component
...
//.background(MaterialTheme.colorScheme.secondary)
            ...
            actions = {
                AppBarActions(darkMode, themeType!!,
                    openDialog)
            }
        )
    }
...
fun MoreAction(themeType: MutableState<ThemeType>) {
    ...
    //val items = listOf(ThemeType.PURPLE, ThemeType.RED,
    //ThemeType.YELLOW, ThemeType.DROWN, ThemeType.GREEN)
    IconButton(
...
fun CustomAppBarPreview() {
    ...
    CustomTopAppBar("App",isDarkMode, themeType =
    null,navController,scope,
